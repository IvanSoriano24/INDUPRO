...
const obtenerPorcentajes = async () => {
  try {
    ...
    if(folioSiguiente != 0){
      ...
      if (costoFijo !== undefined && factoraje !== undefined && utilidad !== undefined && fianzas !== undefined) {
        ...
        par_levDigital.forEach( async (itemTotales) => {
              ...
              await addDoc(cotTotal, {
                  ...
                  costoXpartida: parseInt(itemTotales.cantidad) * (sumaValorLider + sumarCalculoInsumoV),
                  costoUnitario: (sumaValorLider + sumarCalculoInsumoV) * (((costoFijo + factoraje)/100) + 1),  
                  costoFactorizado: (sumaValorLider + sumarCalculoInsumoV) * (((costoFijo + factoraje)/100) + 1) * parseInt(itemTotales.cantidad),
                  precioXpartida: ((sumaValorLider + sumarCalculoInsumoV) * (((costoFijo + factoraje)/100) + 1) * parseInt(itemTotales.cantidad)) / (1 -(utilidad/100)),
                  utilidaEsperada: (((sumaValorLider + sumarCalculoInsumoV) * (((costoFijo + factoraje)/100) + 1) * parseInt(itemTotales.cantidad)) / (1 -(utilidad/100))) - ((sumaValorLider + sumarCalculoInsumoV) * (((costoFijo + factoraje)/100) + 1) * parseInt(itemTotales.cantidad)),
