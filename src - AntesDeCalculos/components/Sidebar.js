    ...
    return (
        <div className="sidebar">
            ...
            <li>
                ...
                <li>
                    <NavLink exact activeClassName="active" to="/factores" className="text-dark rounded py-2 w-100 d-inline-block"><FaPercent className="me-2"/>Insumo por factores</NavLink>
                </li>
            </ul>
