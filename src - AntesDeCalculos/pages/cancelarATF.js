...
const CancelarATF = () => {
                ...
                await addDoc(bitacora, {
                  ...
                  // Si se encuentra un documento que coincide con los identificadores proporcionados, actualiza su estatus
                    if (!querySnapshot.empty) {
                      ...
                      const insuQuery = query(collection(db, 'PAR_TECFIN_INSU'), where('cve_tecFin', '==', cve_tecFin));
                      ...
                      const moQuery = query(collection(db, 'PAR_TECFIN_MO'), where('cve_tecFin', '==', cve_tecFin));
  ...
  return (
    <div className="container">
      <div className="row">
        <div className="col">
          <h1 style={{color:"red"}}><BsExclamationCircleFill /> Cancelar Analisis Técnico financiero</h1>
            <div className="row">
            ...
            <div className="row" style={{ border: '1px solid #000', borderColor: "gray" }}>   
                  ...
                  <table class="table">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Valor hombre</th>
                        <th scope="col">Costo hombre</th>
                      </tr>
                    </thead>
                    <tbody>
              ...
              <br></br>
              <button className="btn btn-danger" onClick={() => mostrarAlerta(cve_tecFin)}><HiMiniDocumentMinus  /> Cancelar documento</button>
        </div>
      </div>
    </div>    
  );
