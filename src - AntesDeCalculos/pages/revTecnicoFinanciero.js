...
const RevTecnicoFinanciero = () => {
    ...
    const getLevDigital = async () => {
        ...
        const levDigital = query(levDigitalCollection, "TECNICOFINANCIERO", where("estatus", "==", "Activo"));
    ...
    const getLevDigitalBloqueadas = async () => {
        ...
        const levDigitalCollection = collection(db, "TECNICOFINANCIERO");
        const levDigital = query(levDigitalCollection, "TECNICOFINANCIERO", where("estatus", "==", "Bloqueado"));
        const levDigitalSnapshot = await getDocs(levDigital);
                        ...
                        <tbody>
                            {levDigital.map((levDigitalItem) => (
                                <tr key={levDigitalItem.id}>
                                    ...
                                    <td><Link to={`/visualizarPDF/${levDigitalItem.id}`} className="btn btn-light"><FaFilePdf /></Link></td>
                                    <td><Link to={`/editarRevTecFinanciero/${levDigitalItem.id}`} className="btn btn-light"><FaPencilAlt /></Link></td>
                                    <td><Link to={`/cancelarATF/${levDigitalItem.id}`} className="btn btn-light"><GrDocumentExcel /></Link></td>
                                </tr>
                            ) )}
                        </tbody>
                    </table>
