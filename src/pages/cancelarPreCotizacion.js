    ...
    <div className="container">
      <div className="row">
        <div className="col">
          ...
          <div
            className="row"
            style={{ border: "1px solid #000", borderColor: "gray", maxHeight: "240px", overflowY: "auto" }}
          >
            <div>
              <br></br>
              <table class="table">
          ...
          <br></br>
          <div className="row" style={{ border: "1px solid #000", borderColor: "gray", maxHeight: "240px", overflowY: "auto" }}>
