                        ...
                        <tbody>
                            {levDigital.map((levDigitalItem) => (
                                <tr key={levDigitalItem.id}>
                                    ...
                                    <td><Link to={`/visualizarPDF/${levDigitalItem.id}`} className="btn btn-success"><Gi3DGlasses /></Link></td>
                                    <td><Link to={`/editarRevTecFinanciero/${levDigitalItem.id}`} className="btn btn-primary"><FaPencilAlt /></Link></td>
