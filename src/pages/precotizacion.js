...
const Precotizacion = () => {
    ...
    const getLevDigital = async () => {
        ...
        const levDigital = query(levDigitalCollection, "PRECOTIZACION", where("estatus", "==", "Activo"));
    ...
    const getLevDigitalBloqueadas = async () => {
        ...
        const levDigitalCollection = collection(db, "PRECOTIZACION");
        const levDigital = query(levDigitalCollection, "PRECOTIZACION", where("estatus", "==", "Bloqueado"));
        const levDigitalSnapshot = await getDocs(levDigital);
                        ...
                        <tbody>
                            {levDigital.map((levDigitalItem) => (
                                <tr key={levDigitalItem.id}>
                                    ...
                                    <td><Link to={`/editarPreCotizacion/${levDigitalItem.id}`} className="btn btn-light"><FaPencilAlt /></Link></td>
                                    <td><Link to={`/cancelarPreCotizacion/${levDigitalItem.id}`} className="btn btn-light"><GrDocumentExcel /></Link></td>                                    
                                </tr>
                            ) )}
                        </tbody>
                    </table>
