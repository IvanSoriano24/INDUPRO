                  ...
                  <tbody>
                    {levDigital.map((levDigitalItem) => (
                      <tr key={levDigitalItem.id}>
                        ...
                        <td>
                          <Link
                            to={`/agregarPreCotizacion/${levDigitalItem.id}`}
                        ...
                        <td>
                          <Link
                            to={`/agregarParLevDigAdicional/${levDigitalItem.id}`}
                            className="btn btn-light"
                          >
                            <FaPencilAlt />
                          </Link>
                        </td>
                        <td><Link to={`/cancelarLevDigital/${levDigitalItem.id}`} className="btn btn-danger"><GrDocumentExcel /></Link></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
                  ...
                  <tbody>
                    {levDigitalB.map((levDigitalItem) => (
                      <tr key={levDigitalItem.id}>
                        ...
                        <td>
                          <Link
                            to={`/segDocLevDig/${levDigitalItem.id}`}
                            className="btn btn-light"
