    ...
    return (
        <div className="sidebar">
            ...
            <li>
                ...
                <li>
                    <NavLink exact activeClassName="active" to="/personalProyectos" className="text-dark rounded py-2 w-100 d-inline-block"><FaUserTie className="me-2"/>Mano de obra</NavLink>
                </li>
                <li>
